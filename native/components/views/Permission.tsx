 ...
 *
 * This component shows an icon and a message, and provides a button that opens the device settings
 * where the user can enable the required permissions (such as location access).
 */
