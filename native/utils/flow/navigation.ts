...
export const direction: Record<string, InstructionStep> = {
  start: createInstruction('explore', 'going to your destination'),
  left: createInstruction('turn-left', 'you should turn to the left'),
  right: createInstruction('turn-right', 'you should turn to the right'),
